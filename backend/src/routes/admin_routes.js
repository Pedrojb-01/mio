...
const { listUsersController, updateUserStatusController, getStatsController, deleteUserController, promoteUserController } = require('../controllers/admin_controller');
...
router.patch('/users/:id/role', guard, admin, promoteUserController);
